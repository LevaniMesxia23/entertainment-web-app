...
function Movies() {
  ...
  return (
    ...
    <div>
    <Header />
    <div className='p-4 lg:ml-[9.25rem]'>
    ...
    <div className=' mb-6'>
        <h1 className='text-white text-[1.25rem] ml-4 lg:ml-[10.25rem]'>Movies</h1>
      </div>
    </div>

    <div className='px-4 grid grid-cols-2 md:grid-cols-3 gap-4 lg:grid-cols-4 lg:ml-[9.25rem]'>

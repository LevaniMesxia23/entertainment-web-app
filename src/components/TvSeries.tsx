  ...
  return (
    ...
    <header>
      <div className=' h-14 bg-[#161D2F] flex justify-between items-center px-4'>
        ...
        <Link to={"/tv-series"}>
        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 4.481H9.08l2.7-3.278L10.22 0 7 3.909 3.78.029 2.22 1.203l2.7 3.278H0V20h20V4.481Zm-8 13.58H2V6.42h10v11.64Zm5-3.88h-2v-1.94h2v1.94Zm0-3.88h-2V8.36h2v1.94Z" fill={location.pathname !== "/tv-series" ? "#5A698F" : "white"}/></svg>
        </Link>
        <Link to={"/bookmarks"}>
    ...
    <div className=' mb-6'>
        <h1 className='text-white text-[1.25rem] ml-4'>TV Series</h1>
      </div>
    </div>
